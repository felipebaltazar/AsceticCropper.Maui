...
{
    public static BindableProperty CornerLengthProperty =
        BindableProperty.Create(nameof(CornerLength), typeof(double), typeof(GridMaskPainter),
    ...
    public static BindableProperty CornerWidthProperty =
        BindableProperty.Create(nameof(CornerWidth), typeof(double), typeof(GridMaskPainter),
    0.0, BindingMode.OneWay);
