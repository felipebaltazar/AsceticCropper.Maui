...
public class RectangleMaskPainter : MaskPainter
{
    ...
    /// </summary>
    public static BindableProperty CornersProperty =
        BindableProperty.Create(nameof(Corners), typeof(CornersEnum), typeof(RectangleMaskPainter), CornersEnum.None, BindingMode.OneWay);

    /// <summary>
    /// The corners radius property.
    /// </summary>
    public static BindableProperty CornerRadiusProperty =
        BindableProperty.Create(nameof(CornerRadius), typeof(double), typeof(RectangleMaskPainter),
